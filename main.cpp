...
static const string mainnet_seeds[] = {
	...
	"dnsseed.pool1.tumblingblock.com", "198.27.82.163",
	"dnsseed.pool3.tumblingblock.com", "192.99.8.7", ""};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 44100), true);
  }
  do {
...
int main(int argc, char **argv) {
  ...
  if (opts.tor) {
    CService service(opts.tor, 44100);
    if (service.IsValid()) {
